...
def visualize_output(output, image, save_dir='output_img&vid', image_name='output.jpg'):
...
output, image = run_inference('inference/images/bus.jpg')
visualize_output(output, image, save_dir='inference', image_name='result.jpg')
